<div class="row row-cards">
    ...
    <div class="card">
      ...
      <div class="table-responsive">
        <table class="table card-table table-striped table-vcenter">
          ...
          <tbody>
            <tr>
              <td class="w-1"><span class="avatar" style="background-image: url(./samples-tabler/demo/faces/male/9.jpg)"></span></td>
            ...
            <tr>
              <td><span class="avatar" style="background-image: url(./samples-tabler/demo/faces/female/1.jpg)"></span></td>
            ...
            <tr>
              <td><span class="avatar" style="background-image: url(./samples-tabler/demo/faces/male/4.jpg)"></span></td>
              <td>Bobby Knight</td>
            ...
            <tr>
              <td><span class="avatar" style="background-image: url(./samples-tabler/demo/faces/female/11.jpg)"></span></td>
              <td>Sharon Wells</td>
              <td>Fixes #625</td>
  ...
  <div class="col-md-6">
    <div class="alert alert-primary">Are you in trouble? <a href="./samples-tabler/docs/index.html" class="alert-link">Read our documentation</a> with code samples.</div>
    <div class="row">
      <div class="col-sm-6">
        <div class="card">
          <div class="card-header">
      ...
      <div class="col-sm-12">
        <a href="https://gumroad.com/l/tabler-email?utm_source=demo" class="card" target="_blank">
          <img src="./samples-tabler/demo/card-demo.jpg" alt="" class="card-img">
        </a>
      </div>
    </div>
  </div>
