  ...
  <div class="col-12">
    <div class="card">
          ...
          <tbody>
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/female/26.jpg)">
     ...
     aria-valuenow="42" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/female/17.jpg)">
                  <span class="avatar-status bg-green"></span>
                </div>
              </td>
              <td>
     ...
     aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/female/21.jpg)">
                  <span class="avatar-status bg-green"></span>
                </div>
              </td>
              <td>
     ...
     aria-valuenow="96" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/male/32.jpg)">
                  <span class="avatar-status bg-green"></span>
                </div>
              </td>
              <td>
     ...
     aria-valuenow="6" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/female/12.jpg)">
                  <span class="avatar-status bg-green"></span>
                </div>
              </td>
              <td>
     ...
     aria-valuenow="36" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/female/4.jpg)">
                  <span class="avatar-status bg-green"></span>
                </div>
              </td>
              <td>
     ...
     aria-valuenow="7" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/female/27.jpg)">
                  <span class="avatar-status bg-green"></span>
                </div>
              </td>
              <td>
     ...
     aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar d-block" style="background-image: url(/samples-tabler/demo/faces/male/20.jpg)">
                  <span class="avatar-status bg-green"></span>
                </div>
              </td>
              <td>
        ...
        <ul class="list-unstyled list-separated">
          <li class="list-separated-item">
            <div class="row align-items-center">
              <div class="col-auto">
                <span class="avatar avatar-md d-block" style="background-image: url(/samples-tabler/demo/faces/female/12.jpg)"></span>
              </div>
              <div class="col">
                <div>
          ...
          <li class="list-separated-item">
            <div class="row align-items-center">
              <div class="col-auto">
                <span class="avatar avatar-md d-block" style="background-image: url(/samples-tabler/demo/faces/female/29.jpg)"></span>
              </div>
              <div class="col">
                <div>
          ...
          <li class="list-separated-item">
            <div class="row align-items-center">
              <div class="col-auto">
                <span class="avatar avatar-md d-block" style="background-image: url(/samples-tabler/demo/faces/female/2.jpg)"></span>
              </div>
              <div class="col">
                <div>
          ...
          <li class="list-separated-item">
            <div class="row align-items-center">
              <div class="col-auto">
                <span class="avatar avatar-md d-block" style="background-image: url(/samples-tabler/demo/faces/male/34.jpg)"></span>
              </div>
              <div class="col">
                <div>
          ...
          <li class="list-separated-item">
            <div class="row align-items-center">
              <div class="col-auto">
                <span class="avatar avatar-md d-block" style="background-image: url(/samples-tabler/demo/faces/female/11.jpg)"></span>
              </div>
              <div class="col">
                <div>
