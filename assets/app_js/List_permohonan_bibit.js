...
function approve(id_dokumen){
  $.ajax({
    url: js_base_url + "List_permohonan_bibit/validasiDokumen",
    dataType: "text",
    type: "POST",
    ...
    success: function(response){
      if (response = "SUCCESS"){
        ...
        $("#tblListPpk").DataTable().ajax.url(js_base_url + "List_permohonan_bibit/getAllPermohonanBibit?tahun_giling=0&tgl_awal=" + "2010-01-01" + "&tgl_akhir=" + "2050-12-31").load();
...
function approveAskep(id_dokumen){
  $.ajax({
    url: js_base_url + "List_permohonan_bibit/validasiDokumenAskep",
    dataType: "text",
    type: "POST",
    data: "id_dokumen=" + id_dokumen,
    success: function(response){
...
$("#tblListPpk").DataTable({
  ...
  autoWidth: false,
  ajax: {
    url: js_base_url + "List_permohonan_bibit/getAllPermohonanBibit?tahun_giling=0&tgl_awal=" + "2010-01-01" + "&tgl_akhir=" + "2050-12-31" ,
    dataSrc: ""
  },
  ...
  columns : [
    ...
    { data: "no_kontrak" },
    {
      data: "jml_kuanta",
      render: function(data, type, row, meta){
        return parseFloat(row.jml_kuanta).toLocaleString({minimumFractionDigits: 2, maximumFractionDigits: 2}) + " HA";
      },
  ...
  initComplete: function(){
    ...
    function refreshTable(){
      ...
      if(tgl_awal != null && tgl_akhir != null){
        ...
        tahun_giling = parseInt($("#tahun_giling").val()) || 0;
        $("#tblListPpk").DataTable().ajax.url(js_base_url + "List_permohonan_bibit/getAllPermohonanBibit?tahun_giling=" + tahun_giling +
  ...
  footerCallback: function (row, data, start, end, display){
    ...
    $(api.column(5).footer()).html('<font color="white" size="3">' + totalRupiah.toLocaleString({maximumFractionDigits: 0}) + ' Ha </font>');
  },
  language: {
    "search": ""
  }
